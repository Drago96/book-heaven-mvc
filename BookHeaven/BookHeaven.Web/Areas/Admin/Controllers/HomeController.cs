...
namespace BookHeaven.Web.Areas.Admin.Controllers
{
    public class HomeController : AdminBaseController
    {
        ...
        {
            var totalUsers = await this.users.GetCountAsync();
            ...
            var locationsWithMostVisits = await this.locations.GetLocationsWithMostVisitsAsync<LocationVisitsServiceModel>(AdminConstants.CountryVisitsToDisplay);
